    ...
    >
      ...
      <div className="p-6 lg:p-8">
        ...
        <div className="flex items-center justify-between mb-4">
          <div
            className={`flex items-center gap-2 text-sm font-medium transition-all duration-200 ${project.status === 'Completed' ? 'text-primary' : 'text-yellow-500'
              }`}
            style={{
...
const projects = [
  {
    title: 'CodeAutoSpy – Automated CI/CD Build Error Fixing System',
    status: 'In Progress',
    date: 'Dec 2025 - Present',
    description: 'An automated system that monitors CI/CD pipelines, detects build failures, analyzes error logs, and generates AI-based code fixes. The system automatically creates Pull Requests with confidence-based safety checks and sends real-time notifications to the development team.',
    tech: ['Node.js', 'Express.js', 'PostgreSQL', 'Bull Queue', 'GitHub API', 'Google Gemini AI', 'Docker'],
    github: 'https://github.com/hariharan-r06/CodeAutoSpy',
    gradient: 'from-blue-500/20 to-purple-500/20',
  },
  {
    title: 'Digital Vehicle Access Control & Monitoring System (Intern)',
    status: 'Completed',
    date: 'Dec 2025',
    description: 'Developed a real-time vehicle entry-exit and billing system using React.js and Spring Boot. Implemented dashboards and REST APIs for live monitoring and automated hourly charge calculation.',
